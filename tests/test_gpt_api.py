...
@pytest.mark.parametrize(
    ...
    (
        ...
        ('SELECT * FROM "public"."users"', "quoted_identifiers_not_allowed"),
        ('SELECT * FROM "gpt_safe"."users"', "quoted_identifiers_not_allowed"),
        ('SELECT "username" FROM users', "quoted_identifiers_not_allowed"),
